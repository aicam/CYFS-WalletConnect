...
import {Marketplace} from '@www/pages/Marketplace/Marketplace';
            ...
            {!isInMarket &&
                <div>
                    <Row>
                        ...
                        <Col span='6'/>
                        <Col>
                            <Button onClick={() => setIsInMarket(true)}>Marketplace</Button>
                        </Col>
                    </Row>
                    <div className='form-title-div'>
                        <Row>
                            ...
                            <Col span='20'>
                                ...
                                <Text className='title-pre-format'>You need to register your project in Verra or Gold
                                    Standard
                                    to provide
            ...
            {isInMarket &&
                <>
                    <Row>
                        <Col span='2'/>
                        <Col span='12'>
                            <Text className='title-pre-format'>Dashboard / Marketplace</Text>
                        </Col>
                        <Col span='6'/>
                        <Col>
                            <Button onClick={() => setIsInMarket(false)}>Define Project</Button>
                        </Col>
                    </Row>
                    <Marketplace/>
                </>}
