...
import { RetrieveProjectRequestParam } from '../../common/routers';
import { makeCommonResponse } from '../util';

export async function retrieveProjectRouter(
    ...
    const messageDecoder = new ProjectDecoder();
    ...
    const projectObject: RetrieveProjectRequestParam = dr.unwrap();
    ...
    const projectResult = gr.unwrap().object;
